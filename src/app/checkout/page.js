...
const PLANS = [
  {
    ...
    period: 'One-time',
    popular: false,
    features: ['1 custom motion ad', 'Clean, modern design', 'Fast delivery (48h)', '1 revision included'],
  },
  {
    id: 'Growth',
    name: 'Growth',
    ...
    period: 'Monthly',
    popular: true,
    features: ['3–5 high-converting motion ads', 'Multiple styles & variations', 'Messaging guidance', 'Optimised for social & ads', 'Fast turnaround', 'Priority support'],
  },
  {
    id: 'Scale',
    name: 'Scale',
    ...
    period: 'Monthly',
    popular: false,
    features: ['High-volume ad creation', 'Multiple variations for testing', 'Advanced messaging direction', 'Faster delivery timelines', 'Ongoing content flow', 'Priority handling'],
  },
]
